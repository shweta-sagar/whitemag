...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> content clearfix"<?php print $attributes; ?>>
   ...
   <div class="panel panel-default">
	...
	<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#price">Price Break Up</a>
        </h4>
      </div>
	...
	<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#photos">Photo Gallery</a>
        </h4>
      </div>
	...
	<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#trip-dates">Trip Dates</a>
        </h4>
      </div>
     <div id="trip-dates" class="panel-collapse collapse in">
        <div class="panel-body">
