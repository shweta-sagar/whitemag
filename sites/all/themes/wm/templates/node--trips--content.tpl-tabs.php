...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> content clearfix"<?php print $attributes; ?>>
	...
	<div class="trip-detail"> 
		...
		<?php print render($content['field_trip_main_image']);?>
		 ...
		 <div class="scoial-detail-trip container">
			<span class="pull-left"><a href="#" class="btn btn-booknow" role="button">BOOK NOW</a></span>
			<span class="pull-left col-md-6"><?php print render($content['sharethis']);?></span>
         </div>
	</div>
	<ul id="tripTab" class="nav nav-tabs" style="">
        <li><a href="#body" data-toggle="tab">Description</a></li>
        <li class="active"><a href="#iteninery" data-toggle="tab">Iteninery</a></li>
		<?php if(!empty($content['field_faqs'])){ ?>
        <li><a href="#faq"  data-toggle="tab">FAQ</a> </li>
		<?php } ?>
		<?php if(!empty($content['field_price_break_up'])){ ?>
        <li><a href="#price"  data-toggle="tab">Price break up</a> </li>
		<?php } ?>
		<?php if(!empty($content['field_trip_images'])){ ?>
        <li><a href="#photos"  data-toggle="tab">Photos</a> </li>
		<?php } ?>
		<?php if(!empty($content['field_trip_date'])){ ?>
        <li><a href="#trip-dates"  data-toggle="tab">Trip dates</a> </li>
		<?php } ?>
    </ul>
   <div id="tripContent" class="tab-content" >
        <div class="tab-pane fade in active" id="body">
		<?php print render($content['body']);?>        
		</div>
        <div class="tab-pane fade" id="iteninery">
		...
		<div class="tab-pane fade" id="trip-dates">
