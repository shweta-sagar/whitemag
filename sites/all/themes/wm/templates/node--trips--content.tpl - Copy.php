...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#iteninery">Iteninery</a></li>
    <li><a data-toggle="tab" href="#faqs">FAQ</a></li>
    <li><a data-toggle="tab" href="#price_break">Price Break Up</a></li>
 </ul>

  <div class="tab-content">
    <div id="iteninery" class="tab-pane fade in active">
      <?php print render($content['field_iteninery']);?>
    </div>
    <div id="faqs" class="tab-pane fade">
     <?php print render($content['field_faqs']);?>
    </div>
    <div id="price_break" class="tab-pane fade">
