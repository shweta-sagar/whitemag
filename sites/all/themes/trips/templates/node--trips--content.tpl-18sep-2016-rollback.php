...
<div id="treking_tab"></div>
 <div class="treking_tab">
          ...
          <div class="row">
            <div class="tab-content">
             ...
             <!-- <div role="tabpanel" class="tab-pane" id="trip">
                <div class="last_tab">
                  <div class="white-wrapper">
                    <div class="trip_box_slide">
                      <div class=" trip_box">
                        <div class="col-xs-12 col-md-6">
                          <div class="trip_picture">
                            <img width="100%" src="images/mount4.jpg">
                            <div class="trip_overlay"></div>
                            <div class="trip_pic_text">
                              <h2>Kang Yatse II Climb (6175m) ain winters</h2>
                        ...
                        <div class="col-xs-12 col-md-6">
                          <div class="trip_picture last_write">
                            <img width="100%" src="images/mount5.jpg">
                            <div class="trip_overlay"></div>
                            <div class="trip_pic_text">
                              <p><a href="#">write your story</a></p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <p class="book_btn"><a href="#">BOOK NOW</a></p>
                  </div>
                </div>
              </div>-->
            </div>
		  ...
		  <?php if($trip_booking){?>
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<th width="75%">Payment/Book Now</th>
					</tr>
			...
			?>
			<tr> 
			<td><span><?php print strip_tags($content['field_trip_date'][$key]['#markup']);?></span></td>
			<td>
			...
			<?php if((strtotime($item['value'])> strtotime("+1 month",strtotime(date('Y-m-d') )))&& ($booking_amt >0)){?>
					 ...
					 <p class="book_btn even"> <input type="Submit" name="advanced" value="ADVANCE BOOKING"></p>
			<?php } ?>
			<p class="book_btn even"><input type="Submit" name="full" value="FULL PAYMENT"></p></form>
			<?php if($booking_amt >0){?>
					<form method="post" action="/pending-payment">
					  <input type="hidden" name="trip_type" value="1">
  					  <input type="hidden" name="start_date" value="<?php print date("d-m-Y", strtotime($item['value']));?>">
					  <input type="hidden" name="end_date" value="<?php print date("d-m-Y", strtotime($item['value2']));;?>">
  					  <input type="hidden" name="trip_amount" value="<?php print $node->field_trip_price['und']['0']['value'];?>">
					  <input type="hidden" name="select_trip" value="<?php print $node->nid;?>">
					  <input type="hidden" name="pending_amt" value="<?php print $pending_amt;?>">
					 <p class="book_btn even"> <input type="Submit" name="pending" value="PENDING PAYMENT"></p>
					</form>
		    <?php } ?>	
					</td>
					</tr>
