...
#usereditborder select
 {color: #585858;width: 100%;max-width: 350px;padding: 5px;border: 1px solid #ccc;
    border-radius: 2px;min-width: 350px;}	
#user-profile-form input[type="submit"] {
    width: 100%;max-width: 350px;padding: 7px;background: #5d5d5d;border: 0;border-radius: 3px;color: #fff;
