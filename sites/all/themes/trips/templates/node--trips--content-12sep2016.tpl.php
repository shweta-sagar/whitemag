 ...
 <div class="treking_tab">
              ...
              <div role="tabpanel" class="tab-pane" id="cost">
                <div class="trek_content">
                  <div class="white-wrapper inclusion-exclusion">
                    <h3>Cost details</h3>
                    <h4><span><i class="icon-rupee"></i></span> <?php print render($content['field_trip_price']); if($content['field_trip_price_us']){?> / <span><i class="icon-dollar"></i></span><?php print render($content['field_trip_price_us']);}?></h4>
                    <div class="mT40">
		  ...
		  <div class="trek_content white-wrapper">
			...
			?>		
					  ...
					  <p class="book_btn <?php if($key%2==0){ print "even";}else{ print" odd";}?>">
