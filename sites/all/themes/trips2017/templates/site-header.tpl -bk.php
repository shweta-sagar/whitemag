 ...
 <div id="sticky-anchor"></div>
  ...
  <div class="main-container">
    ...
    <?php if (!empty($primary_nav) || !empty($secondary_nav) || !empty($page['navigation'])): ?>
        <nav  role="">
		<div class="col-xs-10 col-sm-8 col-md-9 collapse navbar-collapse" id="navbar-collapse-1">
          <?php if ($main_menu): ?>
		...
		<div class="col-xs-12 col-sm-4 col-md-3 nav-secLink">
                      <div class="inside_header_part2 text-right">
                        <ul>
                          <li>
                            <a href="#"><i class="icon-star-empty"></i><span class="secLinks">Favourits</span></a>
                          ...
                          <li><a href="/user" title="My account"><i class="icon-user"></i>
						  <?php if($user->uid){?>
